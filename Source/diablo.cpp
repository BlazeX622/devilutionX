...
static void LoadOptions()
{
	...
	sgOptions.Gameplay.bDisableDropItems = getIniBool("Game", "Disable Drop Items on Death", false);
	sgOptions.Gameplay.bXPAll = getIniBool("Game", "Share XP to All Players", false);
